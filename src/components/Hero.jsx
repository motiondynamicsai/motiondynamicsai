...
import MotionAthlete from '../assets/MotionAthlete.png'; 
    ...
    <section id = "home" className= {'flex md:flex-row flex-col ${styles.paddingY'}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts use a methodology to redesign they way sport is coached, visualised and presented. We use motion caputre technology to give a detail analysis of any athletes performance 
        </p>
      </div>
